...
def infotodict(seqinfo):
    ...
    dwi_6dirs_b2500 = create_key(
        "sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-6dirs_dir-AP_dwi"
    )
    dwi_30dirs_b200 = create_key(
        "sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-30dirs_dir-PA_dwi"
    )
    dwi_45dirs_b1500 = create_key(
        "sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-45dirs_dir-PA_dwi"
    )
    dwi_60dirs_b2500 = create_key(
        "sub-{subject}/{session}/dwi/sub-{subject}_{session}_acq-60dirs_dir-PA_dwi"
    )
