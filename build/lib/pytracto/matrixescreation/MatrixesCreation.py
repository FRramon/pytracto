...
def build_connectivity_matrixes(source_dir, subject_list, ses_list):
            ...
            for gen_met in tckgen_method:
                if gen_met == "Deterministic":
                    sift_file = os.path.join(
                        tracto_dir, "tcksift2Det", "sift_tracks.tck"
                    )
                ...
                for atlas in atlas_list:
                    if atlas == "Destrieux":
                        ...
                        parcellation_file = os.path.join(
                            connectome_dir, "parcels_coreg_schaefer.mif"
                        )
