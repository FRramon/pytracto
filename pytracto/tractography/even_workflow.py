...
def execute_even_workflow(
    ...
    **kwargs: keywords argument for specific pipeline parameters
    ...
    main_wf.connect(
        ...
        'mrcatAP.out_file',
        wf_preproc,
        'b0AP_extract.in_file')
    main_wf.connect(
        wf_preproc,
        'biascorrect.out_file',
        wf_tractography,
        'brainmask.in_file')
    main_wf.connect(
        wf_preproc,
    ...
    main_wf.connect(
        fs_workflow,
        'fs_reconall.aparc_aseg',
        connectome,
        'labelconvert.in_file')
    main_wf.connect(
        wf_tractography,
